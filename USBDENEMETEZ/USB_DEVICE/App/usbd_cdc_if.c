...
uint8_t buf[7];
uint8_t USB_RX_Buf[18];
uint8_t RX_TempBuf[18];
uint8_t rxtempcounter = 0;
typedef union{
	float number;
	uint8_t bytes[4];
}NUMUNION_t;

NUMUNION_t desiredPositionFloatNum0;
NUMUNION_t desiredPositionFloatNum1;
NUMUNION_t desiredPositionFloatNum2;
NUMUNION_t desiredPositionFloatNum3;
/* USER CODE END PV */
